            ...
            <div class="main-catalog__item-bg desktop">
                <picture class="picture">
                    <source type="image/webp"
                            srcset="assets/images/main-catalog-item-bg1.webp">
                    <img class="picture__img"
                         src="assets/images/main-catalog-item-bg1.png">
                </picture>
            </div>
            <div class="main-catalog__item-bg mobile">
                <picture class="picture">
                    <source type="image/webp"
                            srcset="assets/images/main-catalog-item-bg1-mobile.webp">
                    <img class="picture__img"
                         src="assets/images/main-catalog-item-bg1-mobile.png">
                </picture>
            </div>
