...
<div class="news-content__categories" data-aos="fade-up">
    ...
    <form  method="get" id="myForm">
      <div class="catalog-hero__activity" data-aos="fade-up">
                ...
                <div class="catalog-hero__select">
                    <div class="select-wrapper">
                        <div class="select cstm-arrows">
                            <select id = "mySelect" class="select__select" style="width: 100%" data-select-placeholder="Сначала новинки"  name="Sorting" onchange="document.getElementById('myForm').submit()">
                                <option value="" selected="selected" disabled="disabled"></option>
                                <option  value="Сначала новинки" <?php if (isset($_GET["Sorting"])&& $_GET['Sorting'] == 'Сначала новинки'):?> selected="selected" <?php endif;?>>Сначала новинки</option>
                                <option value="Сначала популярные" <?php if (isset($_GET["Sorting"])&& $_GET['Sorting'] == 'Сначала популярные'):?> selected="selected" <?php endif;?>>Сначала популярные</option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <a class="catalog-hero__reset desktop" onclick="onreset()" href="<?=$arResult['CURRENT_SECTION']['SECTION_PAGE_URL']?>">
