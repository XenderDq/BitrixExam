...
<div class="news-content__categories" data-aos="fade-up">
    ...
    <form  method="get">
      <div class="catalog-hero__activity" data-aos="fade-up">
            <label class="catalog-hero__tops desktop" for="top" id="top">
                <?php if ($arResult["FILTERED"][2] !=0):?>
                <input data-privet class="catalog-hero__tops-input catalog-check-desktop" type="checkbox" checked name="top" id="top">
                <?php else:?>
                <input data-privet class="catalog-hero__tops-input catalog-check-desktop" type="checkbox" name="top" id="top">
                <?php endif;?>
                ...
                <div class="catalog-hero__select desktop">
                    <div class="select-wrapper">
                        <div class="select">
                            ...
                            <select class="select__select" style="width: 100%" data-select-placeholder="<?=$arResult["FILTERED"][0];?>" name="top1" id="top1">
                                <option value="" selected="selected" disabled="disabled"></option>
                                <?php foreach($arResult["BRAND"] as $i => $item):?>
                                    <option><?=$item?></option>
                                <?php endforeach;?>
                            </select>
                            <?php else:?>
                                <select class="select__select" style="width: 100%" data-select-placeholder="Брэнды" name="top1" id="top1">
                                    <option value="" selected="selected" disabled="disabled"></option>
                                    <?php foreach($arResult["BRAND"] as $i => $item):?>
                                        <option><?=$item?></option>
                                    <?php endforeach;?>
                    ...
                    <div class="select-wrapper">
                        <div class="select">
                            <?php if ($arResult["FILTERED"][1]!=0):?>
                                <select class="select__select" style="width: 100%" data-select-placeholder="<?=$arResult["FILTERED"][1]?>" name="top2" id="top2">
                                <option value="" selected="selected" disabled="disabled"></option>
                            ...
                            <?php else:?>
                                <select class="select__select" style="width: 100%" data-select-placeholder="Жирность" name="top2" id="top2">
                                    <option value="" selected="selected" disabled="disabled"></option>
                                    <?php foreach($arResult["ZHIR"] as $i => $item):?>
                                        <option><?=$item?></option>
                                    <?php endforeach;?>
                ...
                <div class="catalog-hero__select">
                    <div class="select-wrapper">
                        <div class="select cstm-arrows">
                            <select id = "mySelect" class="select__select" style="width: 100%" data-select-placeholder="Сначала новинки">
                                <option value="" selected="selected" disabled="disabled"></option>
...
?>
    <?php if ($arResult["FILTERED"][1] !=0 || $arResult["FILTERED"][0] !=0 || $arResult["FILTERED"][2] !=0):?>
