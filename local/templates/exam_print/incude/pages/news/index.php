        ...
        <section class="section-mailing news-content__mailing" data-aos="fade-up">
            <div class="section-mailing__bg desktop">
                <picture class="picture">
                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/section-mailing-bg.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/section-mailing-bg.png">
                </picture>
            </div>
            <div class="section-mailing__bg device-bg">
                <picture class="picture">
                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/section-mailing-bg-device.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/section-mailing-bg-device.png">
                </picture>
            </div>
            <div class="section-mailing__bg mobile-bg">
                <picture class="picture">
                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/section-mailing-bg-mobile.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/section-mailing-bg-mobile.png">
                </picture>
            </div>
