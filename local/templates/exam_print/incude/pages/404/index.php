...
?>
    ...
    <section class="error-content top-section container">
        ...
        <div class="error-content__btns"><a class="error-content__btns-item btn-hover_parent" href="index.php">
                <div class="btn-hover_circle"></div><span>Главная</span>
            </a><a class="error-content__btns-item btn-hover_parent" href="#">
                <div class="btn-hover_circle"></div><span>Каталог</span>
            </a></div>
    </section>
