...
?>
    ...
    <section class="work-hero top-section container" data-aos="fade-up">
        <div class="work-hero__breadcrumbs">
            <div class="breadcrumbs">
                <div class="breadcrumbs-wrapper">
                    <div class="breadcrumbs-wrapper__row"><a class="breadcrumbs__item" href="#">главная</a>
                        ...
                        <div class="breadcrumbs__current active">работа у нас</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="work-hero__top" data-aos="fade-up">
            <h1 class="work-hero__title">работа у нас</h1>
        ...
        <div class="work-hero__content" data-aos="fade-up">
            <div class="work-hero__content-col" data-aos="fade-up">
                <div class="work-hero__rect">
                    <div class="work-hero__rect-bg">
                        <picture class="picture">
                            <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/blue-romb-bg.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/blue-romb-bg.png">
                        </picture>
                    </div>
                    <div class="work-hero__rect-box">
                        <div class="work-hero__rect-title">Каждый день мы стремимся к&nbsp;тому, чтобы производить вкусную продукцию.</div>
                        <div class="work-hero__rect-desk">Именно поэтому для нас важно раскрытие потенциала каждого сотрудника.</div>
                        <div class="work-hero__rect-row">
                            <div class="work-hero__rect-item">
                                <div class="work-hero__rect-number">20<sup>+</sup></div>
                                <div class="work-hero__rect-text">лет на российском рынке</div>
                            </div>
                            <div class="work-hero__rect-item">
                                <div class="work-hero__rect-number">600<sup>+</sup></div>
                                <div class="work-hero__rect-text">человек в компании</div>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="work-hero__content-col second" data-aos="fade-up">
                <div class="about-support__slider about-support__slider_work">
                    <div class="swiper swiper-workers">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="about-support__slider-img">
                                    <picture class="picture">
                                        <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/work-slider-img1.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/work-slider-img1.png">
                                    </picture>
                                </div>
                            </div>
                            <div class="swiper-slide">
                        ...
                        <div class="about-support__slider-btns work-hero__slider-btns">
                            <div class="slider-btn btn-hover_parent about-workers__slider-left">
                            ...
                            <div class="slider-btn btn-hover_parent about-workers__slider-right">
                    ...
                    <div class="about-support__slider-pagination swiper-workers__pugination_mobile mobile"></div>
                </div>
            </div>
        </div>
    </section>
    <section class="work-vacancies container" data-aos="fade-up">
        <div class="work-vacancies__top" data-aos="fade-up">
            <h2 class="work-vacancies__title animation-title" data-splitting data-effect1><span>вакансии</span></h2>
        </div>
        <div class="work-vacancies__content" data-aos="fade-up">
            <div class="work-vacancies__jobs">
                <div class="accordion-container">
                    <div class="ac ac-vacancies">
                        <div class="ac-header ac-vacancies__top ac-trigger">
                            <h3 class="ac-vacancies__title">Водитель категории C, Е</h3>
                            <div class="ac-vacancies__salary">от 120 000 ₽</div>
                            <div class="ac-vacancies__btn">
                                <div class="ac-vacancies__btn-plus"><span></span><span></span></div>
                            </div>
                        </div>
                        <div class="ac-panel ac-vacancies__bot">
                            <p>Требуется водитель категории С, Е.</p>
                            <h4>Обязанности</h4>
                            <ul>
                                <li>Доставка замороженных п/ф и мороженого по ЮФО</li>
                                <li>Материально-ответственный</li>
                                <li>Вкус у него будет не самый лучший</li>
                            </ul>
                            <h4>Требования</h4>
                            <ul>
                                <li>Наличие водительского удостоверения категории «Е»</li>
                            </ul>
                            <h4>Условия</h4>
                            <ul>
                                <li>Опыт работы не менее 5 лет</li>
                                <li>Достойная заработная плата</li>
                                <li>Подробности обсуждаются на собеседовании</li>
                            </ul>
                            <div class="ac-vacancies__button btn-hover_parent no-scale" data-popup="form-vacancies">
                    ...
                    <div class="ac ac-vacancies">
                        <div class="ac-header ac-vacancies__top ac-trigger">
                            <h3 class="ac-vacancies__title">Водитель категории C, Е</h3>
                            <div class="ac-vacancies__salary">от 65 000 ₽</div>
                            <div class="ac-vacancies__btn">
                                <div class="ac-vacancies__btn-plus"><span></span><span></span></div>
                            </div>
                        </div>
            ...
            <div class="work-vacancies__mail">
                <p class="work-vacancies__mail-text">Даже если прямо сейчас у нас нет подходящей вакансии, вы можете присылать свои предложения о сотрудничестве, портфолио и резюме на адрес <a href="mailto:zdor_prod@mail.ru">zdor_prod@mail.ru</a>, мы обязательно ответим.</p>
            </div>
        </div>
    </section>
    <div class="popup popup-vacancies" data-popup-wrapper="form-vacancies" data-overlay-on>
        <div class="about-production__popup-btn" data-popup-close="form-vacancies">
        ...
        <div class="popup-vacancies__inner" data-form-wrapper="vacancies">
            <div class="popup-vacancies__wrapper">
                <div class="popup-vacancies__title">Откликнуться на&nbsp;вакансию</div>
                <form class="popup-vacancies__form" action="" data-form="vacancies">
                    ...
                    <div class="input-wrapper input-wrapper_textarea" data-input-parent="">
                        <div class="input-wrapper__placeholder placeholder_background">Текст сопроводительного письма</div><textarea class="textarea" data-input="" type="text" placeholder="Текст сопроводительного письма"></textarea>
                    </div>
                    <lable class="popup-vacancies__form-label btn-hover_parent" for="file">
                        <div class="btn-hover_circle white"></div>
                        <div class="popup-vacancies__form-icon"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 6.25C4.82436 6.25 2.25 8.82436 2.25 12C2.25 15.1756 4.82436 17.75 8 17.75C8.41421 17.75 8.75 17.4142 8.75 17C8.75 16.5858 8.41421 16.25 8 16.25C5.65279 16.25 3.75 14.3472 3.75 12C3.75 9.65279 5.65279 7.75 8 7.75C8.41421 7.75 8.75 7.41421 8.75 7C8.75 6.58579 8.41421 6.25 8 6.25Z" fill="#0068FF"></path>
                                <path d="M16 6.25C15.5858 6.25 15.25 6.58579 15.25 7C15.25 7.41421 15.5858 7.75 16 7.75C18.3472 7.75 20.25 9.65279 20.25 12C20.25 14.3472 18.3472 16.25 16 16.25C15.5858 16.25 15.25 16.5858 15.25 17C15.25 17.4142 15.5858 17.75 16 17.75C19.1756 17.75 21.75 15.1756 21.75 12C21.75 8.82436 19.1756 6.25 16 6.25Z" fill="#0068FF"></path>
                                <path d="M8 11.25C7.58579 11.25 7.25 11.5858 7.25 12C7.25 12.4142 7.58579 12.75 8 12.75H16C16.4142 12.75 16.75 12.4142 16.75 12C16.75 11.5858 16.4142 11.25 16 11.25H8Z" fill="#0068FF"></path>
                            </svg></div>
                        <div class="popup-vacancies__form-text">Прикрепить файл</div><input class="popup-vacancies__form-file" type="file" name="file" id="file">
                    </lable>
                    <p class="popup-vacancies__form-policy">Нажимая на кнопку «Отправить», вы даете согласие с&nbsp;<a href="#">политикой в отношении обработки персональных данных</a></p><button class="popup-vacancies__form-button btn-hover_parent" type="submit" data-form-button="vacancies">
                        <div class="btn-hover_circle"></div><span>Отправить</span>
                    </button>
                </form>
            </div>
        </div>
        <div class="popup-vacancies__send" data-form-send="vacancies">
            <div class="popup-vacancies__send-inner">
                ...
                <div class="popup-vacancies__send-btn btn-hover_parent" data-popup-close="form-vacancies">
