...
?>
                ...
                <div class="swiper main-swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide main-slider__slide">
                            <div class="main-slider__slide-bg desktop" data-swiper-parallax="1440" data-bg-parallax>
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg1.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg1.png">
                                </picture>
                            </div>
                        ...
                        <div class="swiper-slide main-slider__slide">
                            <div class="main-slider__slide-bg desktop" data-swiper-parallax="1440" data-bg-parallax>
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg2.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg2.png">
                                </picture>
                            </div>
                            <div class="main-slider__slide-bg devices">
                                <picture class="picture">
                        ...
                        <div class="swiper-slide main-slider__slide">
                            <div class="main-slider__slide-bg desktop" data-swiper-parallax="1440" data-bg-parallax>
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg3.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg3.png">
                                </picture>
                            </div>
                            <div class="main-slider__slide-bg devices">
                                <picture class="picture">
                        ...
                        <div class="swiper-slide main-slider__slide">
                            <div class="main-slider__slide-bg desktop" data-swiper-parallax="1440" data-bg-parallax>
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg4.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg4.png">
                                </picture>
                            </div>
                            <div class="main-slider__slide-bg devices">
                                <picture class="picture">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide main-slider__slide">
                            <div class="main-slider__slide-bg mobile bg-bg-bg">
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg1-mobile.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg1-mobile.png">
                                </picture>
                            </div>
                            <div class="main-slider__content">
                        ...
                        <div class="swiper-slide main-slider__slide">
                            <div class="main-slider__slide-bg mobile bg-bg-bg">
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg2-mobile.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg2-mobile.png">
                                </picture>
                            </div>
                            <div class="main-slider__content">
                                <div class="main-slider__content-icon"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="70" viewbox="0 0 100 70" fill="none">
                        ...
                        <div class="swiper-slide main-slider__slide">
                            <div class="main-slider__slide-bg mobile bg-bg-bg">
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg3-mobile.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg3-mobile.png">
                                </picture>
                            </div>
                            <div class="main-slider__content">
                                <div class="main-slider__content-icon"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="70" viewbox="0 0 100 70" fill="none">
                        ...
                        <div class="swiper-slide main-slider__slide">
                            <div class="main-slider__slide-bg mobile bg-bg-bg">
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg4-mobile.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg4-mobile.png">
                                </picture>
                            </div>
                            <div class="main-slider__content">
                                <div class="main-slider__content-icon"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="70" viewbox="0 0 100 70" fill="none">
                        ...
                        <div class="swiper-slide main-slider__slide">
                            <div class="main-slider__slide-bg mobile bg-bg-bg">
                                <picture class="picture">
                                    <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg5-mobile.webp"><img class="picture__img" src="<?=SITE_TEMPLATE_PATH?>/assets/images/main-slider-bg5-mobile.png">
                                </picture>
                            </div>
                            <div class="main-slider__content">
                                <div class="main-slider__content-icon"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="70" viewbox="0 0 100 70" fill="none">
    ...
    <section class="main-filials container" data-aos="fade-up" data-aos-duration="1500">
        ...
        <div class="main-filials__bottom" data-aos="fade-up" data-aos-duration="1500"><a class="main-filials__card where-buy btn-hover_parent" href="#">
            ...
            <a class="main-filials__card game btn-hover_parent" href="#" target="blank">
